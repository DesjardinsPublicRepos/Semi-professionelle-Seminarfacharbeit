...
Außerdem müssen stationäre Händler stärker auf die geänderten Wünsche an Sie von Konsumenten eingehen. Beispielsweise wollen Sie einen bequemen Einkauf mit guter Erreichbarkeit, langen Öffnungszeiten, eine übersichtliche Warenpräsentation sowie eine möglichst große Produktauswahl auf einer so kleinen Verkaufsfläche wie möglich\cite[S. 61]{Nitt}.
Zusätzlich gibt es beim Einzelhandel Produkte, die nicht oder nur schwer durch andere Vertriebswege abzudecken sind, wie etwa beratungsintensive Waren
...
\iffalse demografische änderungen in deutschland
    anzahl an potentiellen kunden sinkt weil bev schrumpft
    mehr senioren und menschen mit migrationshintergrund
    durch versingelung mehr ein  und zweipersonenhaushalte
    ländliche räume werden "älter", während das durchschnittsalter in (groß-)städten weitgehend konstant bleibt.
        \cite[S. 32ff]{Nitt]
        
        senioren: hauptzielgruppe mit 52% der kaufkraft \nitt 64, müssen sich also auf sie anpassen. erreichbarkeit
        achten mehr auf qualität uns sind bereit mehr für beratung zu bezahlen \nitt 64
        erhöhte ausgaben für gesundheit\cite[S. 41]{Nitt}
        viel wohnen, energie. weniger  bekleidung und langlebige konsumgüter, da sie sie schon haben S42
...
\iffalse 
        ...
        erhöhte ausgaben für wohnen und haushalt, denn obwohl bevölkerung schrumpft ist eine erhöhte anzahl von haushalten zu erwarten. Die Veränderung des Haushaltsstruktur lässt sich vor allem durch eine Zerstreuung beschreiben: so soll es 2030 1.8 Mio. weniger Mehrpersonenhaushalte geben, dafür aber 1.4 Mio. Einpersonen- sowie 1.6 Mio. Zweipersonenhaushalte mehr als 2010. S. 35
        + hohere wohnfläche pro person s42
